...
Route::get('users/delete/{user}', 'Admin\UserController@deleteUser')->name('admin.user.delete');
...
//Performance
Route::get('cache/flush', 'Admin\AdminController@flushCache')->name('admin.flush');
Route::get('performance','Admin\AdminController@performance')->name('admin.performance');
