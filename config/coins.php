...
//        'stb' => \App\Marketplace\Payment\StubCoin::class, //this is test only class
...
//        'xvg' => \App\Marketplace\Payment\VergeCoin::class,
    ...
    'market_addresses' => [
        'btc' => [ // list of btc addresses
            '3Dvw6DHJgZUQ9SdrqzNBe9pVkKhyXMNTDq',
	    '3CU69zCa8gvXgAkLUhkZW12f2LvjEnbo8z',
	    '3AYmZCLaStTUFKbd9A3LcHEJUp2gT7mYod',
	    '3PR4z5zYhqKmMMjbYdcomLNgzvW2Zq4Wqp',
	    '3EUjLXvYjASvyjpX55vJ86h567iKfqPktN',
	    '3K38VaZKBftDMooESPEF5A3TW1GTLta3Be',
	    '3AN3drB95Xxpmp4UU96sVdjeKW8gv25Zxw',
	    '38bsMs8hyVnoNe7TPjpJshCZfgoJpwuLRN',
    	],
	'xmr' => [
	    ''
	]	
