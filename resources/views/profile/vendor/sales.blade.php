            ...
            <tr>
                ...
                <td class="text-right">
                    @if($purchase -> shipping)
                        <p class="text-muted text-sm-center">{{ $purchase -> shipping -> name }} - @include('includes.currency', ['value' => $purchase -> shipping -> price])</p>
                    @else
                        <span class="badge badge-info">Digital delivery</span>
                    @endif
                </td>
                <td class="text-right">
                    <span class="badge badge-mblue">@include('includes.currency', ['value' => $purchase -> value_sum])</span>
                </td>
                <td>
