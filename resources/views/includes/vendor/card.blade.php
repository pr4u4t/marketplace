<div class="card mt-5 profile-card border border-secondary" >
    <div class="card-body">
        <div class="row">
            <div class="@unless(isset($summary) and $summary === true) col-sm-3 @else col-sm-12 @endunless">
                <h4>
                    <a href="{{ route('vendor.show', $vendor) }}" style="color: black">{{ $vendor->username }}</a>
                </h4>
                <p> 
                    <span class="btn @if($vendor->vendor->experience >= 0) btn-primary @else btn-danger @endif active" style="cursor:default">
            ...
            @unless(isset($summary) and $summary === true)
            <div class="col-sm-4 text-right">
                <p>
                    <a href="{{ route('profile.messages').'?otherParty='.$vendor->username}}" class="btn btn-outline-secondary">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                @if(isset($summary) and $summary === true )
