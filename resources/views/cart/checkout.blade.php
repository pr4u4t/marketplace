...
@section('content')
    <div class="row">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <span class="badge badge-mblue">
                                    @include('includes.currency', ['value' => $item -> offer -> price])
                                </span>
                            </td>
                            <td class="text-center">
                            ...
                            <td class="text-center">
                                ...
                                @if($item -> shipping)
                                    {{ $item -> shipping -> name }} -
                                    @include('includes.currency', ['value' => $item -> shipping -> price])
                                @else
                            ...
                            <td class="text-center">
                                <span class="badge badge-mblue">
                                    @include('includes.currency', ['value' => $item -> value_sum])
                                </span>
                            </td>
                            <td>
                                @if($item -> message)
        ...
        <div class="col-md-8 text-right">
            <h3 class="text-right d-inline-block mr-2">Total: @include('includes.currency', ['value' => $totalSum])</h3>
        </div>
