...
class Vendor extends User
{
    ...
    /**
     * @return Collection of \App\User instances of all vendors
     */
    public static function allUsers(){
        return User::whereIn('id', Vendor::all()->pluck('id'))->get();
    }

    public static function allVendors(){
        return User::whereIn('id', Vendor::all()->pluck('id'))->paginate(9);
    }
    ...
    public function isTrusted(): bool{
        ...
        return ($lvl >= config('marketplace.trusted_vendor.min_lvl') &&
    ...
    public function isDwc(): bool{
        return ($this->countFeedbackByType('negative') > config('marketplace.vendor_dwc_tag_count')) ? true : false;
    }
