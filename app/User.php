...
class User extends Authenticatable
{
    ...
    /**
     * Sets the JavaScript warning on or off
     *
     * @param $turn
     * @throws RequestException
     */
    public function setJSWarn($turn){
        $this->jswarn = $turn == true;
        $this->save();
    }
    ...
    public function setcurrency($currency){
        ...
        $this->save();
        session()->put('local_currency',$this->currency);
    }
    ...
    public function getLocalCurrency(){
        ...
        if(isset($this->currency) and $this->currency != ''){
